...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-11-2023 a las 01:00:07
...
(1, 123456, 'Pepe', 'Argento', 24965, 'abc123', 24678, 1),
(2, 246859, 'Manuelita', 'Pehuajo', 789465, 'abc124', 456123, 1),
(7, 159753, 'Laura', 'Mendez', 486123, 'abc125', 954324, 1);
...
(5, 'Fifi', 'M', 'Canino', 'Caniche', 'Blanco', '2021-08-11', 1, 1),
(6, 'Manchas', 'F', 'Felino', 'Siames', 'Gris y blanco', '2020-08-05', 2, 1),
(7, 'Rulo', 'M', 'Canino', 'Golden', 'Naranja', '2020-08-26', 7, 1);
...
(1, 'primera vacunacion', 'gatovac', 2500, 'vacuna', 1),
(2, 'castracion', 'tijeras', 8000, 'castracion', 1);
...
(1, 6, '2023-08-23', 'vacunacion', 3, 1, 1),
(2, 5, '2023-08-22', 'castracion', 2.5, 2, 1);
...
--
ALTER TABLE `visita`
  ADD CONSTRAINT `visita_ibfk_1` FOREIGN KEY (`idTratamiento`) REFERENCES `tratamiento` (`idTratamiento`) ON DELETE NO ACTION ON UPDATE NO ACTION,
